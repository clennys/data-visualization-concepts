...
def update_sub_col(attrname, old, new):
    ...
    sub_ft_selected = ...
    layout.children[1].children[2] = draw_subplot(...)

select_col_pca.on_change(...)
select_col_sub.on_change(...)
...
p_pca.renderers[0].data_source.selected.on_change(...)
